package com.denver.weather_gcash_app.helper.provider;
    ...
    public Location initLocation(Context context) {
        try {
            ...
            if (!isGpsEnabled && !isNetworkEnabled) {
                Timber.tag("GEO").i("Gps not enabled or no network available");
            } else {
                canGetLocation = true;
                if (isNetworkEnabled) {
                    ...
                    if (locationManager != null) {
                        ...
                        if (location != null) {
                            ...
                            Timber.tag("GEO").i("{Network} - Location is null...");
                        }
                    } else {
                        Timber.tag("GEO").i("{Network} - Location manager is null...");
                    }
                }
                    ...
                    if (location == null) {
                        ...
                        if (locationManager != null) {
                            ...
                            if (location != null) {
                                ...
                                Timber.tag("GEO").i("{GPS} - Location is null...");
                            }
                        } else {
                            Timber.tag("GEO").i("{GPS} - Location manager is null...");
                        }
                    }
                }
            }
